...
<body class="h-full bg-[#f8f9fa]">
    <!-- Agregar clase al botón del menú -->
    ...
    <div class="main-content">
        ...
        <main class="p-4 sm:p-6">
            <div class="page bg-white rounded-lg border shadow-sm p-4 sm:p-8 max-w-4xl mx-auto">
                <div class="text-center mb-4 sm:mb-8">
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Consentimiento Médico</h1>
                </div>
                ...
                <!-- Firmas -->
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 mt-4 sm:mt-8">
