            ...
            <div class="col-md-9 col-lg-10">
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Editar Doctor</li>
                    </ol>
                </nav>

                <div class="card">
                    <div class="card-header-users">
                        <h5 class="mb-0"><i class="bi bi-pencil-square"></i> Editar Doctor</h5>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($error)): ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mt-4">
                                        <input class="form-check-input" type="checkbox" id="activo" name="activo" <?php echo ($doctor['activo']) ? 'checked' : ''; ?>>
