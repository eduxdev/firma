            ...
            <div class="w-full md:w-3/4 lg:w-5/6">
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    <div class="bg-users text-white p-4 rounded-t-lg">
                        <h5 class="m-0 font-medium"><i class="bi bi-pencil-square"></i> Editar Doctor</h5>
                    </div>
                    <div class="p-6">
                        <?php if (!empty($error)): ?>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                                    ...
                                    <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary" 
                                           id="nombre" name="nombre" value="<?php echo htmlspecialchars($doctor['nombre']); ?>" required>
                                </div>
                                <div class="w-full md:w-1/2 px-3">
                                    <label for="apellido" class="block text-gray-700 mb-2">Apellido <span class="text-red-500">*</span></label>
                                    <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary" 
                                           id="apellido" name="apellido" value="<?php echo htmlspecialchars($doctor['apellido']); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                                    ...
                                    <input type="email" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary" 
                                           id="email" name="email" value="<?php echo htmlspecialchars($doctor['email']); ?>" required>
                                </div>
                                <div class="w-full md:w-1/2 px-3">
                                    <label for="password" class="block text-gray-700 mb-2">Contraseña <small class="text-gray-500">(Dejar vacío para mantener la actual)</small></label>
