...
if (isset($_POST['eliminar_formulario']) && isset($_POST['form_id'])) {
    ...
    // Verificar que el formulario existe y está rechazado
    $check_sql = "SELECT id FROM formularios_consentimiento WHERE id = ? AND estado_revision = 'rechazado'";
    ...
    if ($check_result->num_rows > 0) {
        ...
        $_SESSION['error'] = "El formulario no existe o no está rechazado.";
    }
