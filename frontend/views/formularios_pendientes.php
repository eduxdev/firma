                            ...
                            <div class="grid grid-cols-1 gap-4 p-4">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
                                    <div class="flex items-center gap-3 mb-3">
                                        <div class="h-10 w-10 rounded-full bg-amber-100/75 flex items-center justify-center">
                                            <i class="bi bi-person text-amber-600"></i>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex items-center gap-2 text-xs text-gray-500">
                                                ...
                                                <span><?php echo date('d/m/Y', strtotime($row['fecha_creacion'])); ?></span>
                                                <span>•</span>
                                                <span><?php echo date('H:i', strtotime($row['fecha_creacion'])); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex flex-col sm:flex-row gap-2">
                                        <a href="ver_formulario.php?id=<?php echo $row['id']; ?>" 
                                           class="flex-1 inline-flex items-center justify-center h-9 rounded-md px-3 text-sm font-medium border border-gray-200 bg-white text-gray-900 shadow-sm hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50">
                                            <i class="bi bi-eye me-2"></i> Ver Formulario
                                        </a>
                                        <button type="button" 
                                                @click="showModal = true; formId = <?php echo $row['id']; ?>; formNombre = '<?php echo htmlspecialchars($row['nombre'] . ' ' . $row['apellido']); ?>'"
                                                class="flex-1 inline-flex items-center justify-center h-9 rounded-md px-3 text-sm font-medium bg-red-600 text-white shadow-sm hover:bg-red-700 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-red-950 disabled:pointer-events-none disabled:opacity-50">
                                            <i class="bi bi-trash me-2"></i> Eliminar
                                        </button>
                                    </div>
                                </div>
